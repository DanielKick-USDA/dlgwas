...
# %% auto 0
__all__ = ['ensure_dir_path_exists', 'get_cached_result', 'put_cached_result', 'get_kegg_species_list', 'mkdf_kegg_species_list',
           'download_kegg_gene', 'read_kegg_gene']
...
# %% ../nbs/01_zma_kegg_download.ipynb 19
...
# %% ../nbs/01_zma_kegg_download.ipynb 20
def read_kegg_gene(
